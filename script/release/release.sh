...
mvn spring-boot:build-image -Dspring-boot.build-image.imageName=mc/mc-msg-consumer:$1
docker tag docker.io/mc/mc-msg-consumer:$1  192.168.1.163:32037/docker.io/mc/mc-msg-consumer:$1
docker push 192.168.1.163:32037/docker.io/mc/mc-msg-consumer:$1
